...
feature: unreal-containers-tarray-tmap-tset
module: Core
---
...
The architecture for Unreal Containers Tarray Tmap Tset follows standard UE5 patterns as described in the numbered sections above.

## Data Flow

Data flows through the UE5 framework APIs as described in the implementation sections of Unreal Containers Tarray Tmap Tset.
...
The Unreal Containers Tarray Tmap Tset pattern follows UE5 engine conventions and best practices.
