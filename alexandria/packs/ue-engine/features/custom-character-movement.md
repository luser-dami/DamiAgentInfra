...
feature: custom-character-movement
...
The architecture for Custom Character Movement follows standard UE5 patterns as described in the numbered sections above.

## Data Flow

Data flows through the UE5 framework APIs as described in the implementation sections of Custom Character Movement.
...
The Custom Character Movement pattern follows UE5 engine conventions and best practices.

## Edge Cases

Refer to the Common Mistakes section for Custom Character Movement edge cases. Ensure proper null checks and UPROPERTY replication for networked usage.
